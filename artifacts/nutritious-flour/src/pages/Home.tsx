...
const REVIEWS = [
  {
    ...
    location: "Mwea",
    rating: 5,
    text: "Nimekuwa nikiamini Unga Sawa Mix kwa miaka miwili sasa. Uji wao ni mzuri sana na watoto wangu wanafurahi kunywa kila asubuhi. Asante sana!",
  },
  {
    name: "Peter Kamau",
    initials: "PK",
    location: "Kirinyaga",
    rating: 5,
    text: "The Pishori rice from here is the best in the area. Fresh, clean, and fairly priced. I always come back whenever I need quality cereals for my family.",
  },
  {
    name: "Grace Njeri",
    initials: "GN",
    location: "Mwea",
    rating: 5,
    text: "Nilinunua uji wa mtoto wangu hapa na matokeo yamekuwa mazuri sana. Mtoto wangu wa miezi 8 anakula vizuri ana nguvu. Bidhaa ni safi na ya asili.",
  },
  {
    name: "James Mwangi",
    initials: "JM",
    location: "Kerugoya",
    rating: 5,
    text: "Very honest business. Prices are fair and the quality never disappoints. I get my honey and kamande from here every month. Highly recommend to anyone in Mwea.",
  },
  {
    name: "Esther Auma",
    initials: "EA",
    location: "Mwea",
    rating: 5,
    text: "Unga Sawa Mix ndio duka bora kwa uji wa kienyeji. Ninashukuru sana kwa huduma nzuri na bei nzuri. Familia yangu yote inapenda sana.",
  },
  {
    name: "Samuel Otieno",
    initials: "SO",
    location: "Mwea Town",
    rating: 5,
    text: "Got my njahi and ndengu here last week. Very clean and well sorted. The lady at the shop was also very helpful and explained the nutritional benefits. Will definitely return.",
  },
];
...
const FOOTER_LINKS = [
  ...
  { name: "Baby Flour", href: "#baby-flour" },
...
export default function Home({ onAddToCart }: HomeProps) {
  ...
  return (
    <main>
      ...
      <section id="hero" className="relative min-h-screen flex flex-col items-start justify-center overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 md:px-6 pt-28 pb-20">
          ...
          <div className="flex flex-wrap gap-4">
            <a
              href="#baby-flour"
              onClick={e => smoothScroll(e, "#baby-flour")}
              className="px-8 py-4 bg-primary text-primary-foreground rounded-full text-lg font-medium hover:bg-primary/90 transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5"
            ...
            <a
              ...
              className="px-8 py-4 border-2 border-foreground/20 text-foreground rounded-full text-lg font-medium hover:border-foreground/40 hover:bg-muted/30 transition-all"
      ...
      <section id="overview" className="py-24 bg-muted/30">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { label: "Baby Flour", href: "#baby-flour", emoji: "🌱", desc: "Specially crafted for infants and toddlers from 6 months and above. Packed with the essential nutrients growing children need — no additives, no shortcuts." },
              { label: "Adult Uji & Legumes", href: "#adult-uji", emoji: "🌾", desc: "Wholesome uji flour and quality legumes for the whole family. Freshly milled and carefully sourced — nutritious, filling, and affordable." },
              { label: "Cereals & More", href: "#cereals", emoji: "🌾", desc: "Premium quality rice, natural honey, and fresh kienyeji eggs — sourced carefully and always available at our shop in Mwea." },
              { label: "Milling Services", href: "#milling", emoji: "⚙️", desc: "Bring your grain to us and we will mill it fresh for you. Fast, clean, and reliable — right here in Mwea." },
            ].map(cat => (
              <a
                key={cat.label}
                href={cat.href}
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {WHY_US_REASONS.map(reason => (
              <div
                key={reason.title}
                className="bg-card rounded-2xl border border-border/60 p-6 hover:shadow-sm transition-shadow"
          ...
          <div className="text-center mt-10">
            <a
              href="#shop"
              onClick={e => smoothScroll(e, "#shop")}
              className="inline-flex items-center gap-2 px-8 py-4 bg-primary text-primary-foreground rounded-full font-semibold hover:bg-primary/90 transition-all shadow hover:-translate-y-0.5"
      ...
      {/* ── BABY FLOUR ── */}
      <section id="baby-flour" className="py-24 bg-muted/30">
        <div className="container mx-auto px-4 md:px-6">
          <div className="mb-12">
      ...
      <section id="adult-uji" className="py-24 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <div className="mb-12">
            <span className="text-xs font-semibold text-primary uppercase tracking-widest">Category</span>
            <h2 className="text-4xl font-serif font-bold text-foreground mt-1 mb-3">Adult Uji & Legumes</h2>
          ...
          {/* Adult Uji Ingredients — immediately after Adult Uji product, before legumes */}
          <div className="bg-primary/5 rounded-2xl border border-primary/20 p-6 mb-12 max-w-2xl">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mb-5">
              Our uji flour is carefully made from natural ingredients including sorghum, sunflower seeds, pumpkin, moringa seeds, cassava, green bananas, and other wholesome grains. Rich in vitamins, minerals, fiber, iron, and calcium — food that truly nourishes.
            </p>
            <div className="flex flex-wrap gap-2">
          ...
          {/* Legumes grid — after adult uji and ingredients */}
          <div>
            <h3 className="font-bold text-2xl text-foreground mb-3">Legumes & More</h3>
      ...
      {/* ── CEREALS ── */}
      <section id="cereals" className="py-24 bg-muted/30">
        <div className="container mx-auto px-4 md:px-6">
          <div className="mb-12">
            <span className="text-xs font-semibold text-primary uppercase tracking-widest">Category</span>
            <h2 className="text-4xl font-serif font-bold text-foreground mt-1 mb-3">Cereals & More</h2>
            <p className="text-muted-foreground max-w-xl">
      ...
      {/* ── MILLING ── */}
      <section id="milling" className="py-24 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <div className="mb-12">
            <span className="text-xs font-semibold text-primary uppercase tracking-widest">Category</span>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-start">
            ...
            <div className="space-y-5">
              {MILLING.map(s => (
                <div key={s.id} className="bg-muted/30 rounded-2xl p-6 border border-border/50 hover:shadow-sm transition-shadow">
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {REVIEWS.map((r, i) => (
              <div
                key={i}
                className="bg-card rounded-2xl border border-border/60 p-6 hover:shadow-md transition-shadow flex flex-col"
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-[2rem] shadow-xl p-8 md:p-12 border border-border/50">
              ...
              <div className="flex items-start gap-4 p-6 bg-muted/30 rounded-2xl">
                ...
                <div>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-primary text-xs hover:underline mt-1 inline-block underline underline-offset-2"
                  >
                    Get Directions
                  </a>
                </div>
            ...
            <div className="text-center">
              <a
                href="tel:+254721339862"
                className="inline-flex items-center gap-2 px-8 py-4 bg-primary text-primary-foreground rounded-full text-lg font-medium hover:bg-primary/90 transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5 mr-3"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-8 py-4 bg-[#25D366] text-white rounded-full text-lg font-medium hover:bg-[#1ebe5d] transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5"
        ...
        <div className="container mx-auto px-4 md:px-6 py-16">
                ...
                {FOOTER_LINKS.map(link => (
                  <li key={link.name}>
                    <a
                      ...
                      className="text-[hsl(46,35%,96%)]/70 text-sm hover:text-[hsl(46,35%,96%)] transition-colors"
                    >
                      {link.name}
                    </a>
                  </li>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-[hsl(46,35%,96%)]/60 text-xs hover:text-[hsl(46,35%,96%)] transition-colors mt-1 inline-block underline underline-offset-2"
                    >
                      Get Directions
                    </a>
                  </div>
                ...
                <li className="flex items-center gap-3">
                  ...
                  <a
                    href="tel:+254721339862"
                    className="text-[hsl(46,35%,96%)]/80 text-sm hover:text-[hsl(46,35%,96%)] transition-colors"
                  >
                    0721 339 862
                  </a>
                </li>
          ...
          <div className="border-t border-[hsl(46,35%,96%)]/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="text-center md:text-left">
              <p className="text-2xl font-serif font-bold text-[hsl(46,35%,96%)] leading-tight">
                Healthy food.<br />
                <span className="text-primary italic">Pure ingredients.</span><br />
                Happy homes.
              </p>
